...
from src.frechetmean.backward import frechet_ball_backward, frechet_hyperboloid_backward
from src.frechetmean.forward import frechet_ball_forward, frechet_hyperboloid_forward
from src.frechetmean.manifolds import Lorentz, Poincare, get_manifold_id
...
def frechet_mean(x, manifold, w=None):
    ...
    return FrechetMean.apply(x.detach(), w.detach(), manifold.K, get_manifold_id(manifold))
